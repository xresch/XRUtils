 ...
 * @license MIT-License
 **************************************************************************************************************/
public class XRDBInterface {

	private static Logger logger = LoggerFactory.getLogger(XRDBInterface.class.getName());
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfaceH2(String servername, int port, String storePath, String databaseName, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfaceH2AutoServer(int port, String storePath, String databaseName, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfaceMySQL(String uniqueNamePrefix, String servername, int port, String dbName, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfacePostgres(String uniqueNamePrefix, String servername, int port, String dbName, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfaceMSSQL(String uniqueNamePrefix, String servername, int port, String dbName, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterfaceOracle(String uniqueNamePrefix, String servername, int port, String name, String type, String username, String password) {
	 ...
	 * 
	 ************************************************************************/
	public static XRDBInterface createDBInterface(String uniquepoolName, String driverName, String url, String username, String password) {
	...
	public static XRDBInterface createDBInterface(String uniquepoolName, String driverName, String url, String username, String password, String validationQuery) {
		...
		try {
			...
			XRDBInterface.registerManagedConnectionPool(uniquepoolName, datasource);
		...
		XRDBInterface db = new XRDBInterface(datasource);
