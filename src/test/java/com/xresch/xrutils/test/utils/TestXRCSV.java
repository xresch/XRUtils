...
public class TestXRCSV {
	...
	public void testSplitCSVQuotesAware() {
		...
		// Single Chars
		//---------------------------------
		splitted = XRCSV.splitCSVQuotesAware(",", "a,b,c");
		
		System.out.println("splitted: "+XR.JSON.toJSON(splitted));
		...
		// Multiple Chars
		//---------------------------------
		splitted = XRCSV.splitCSVQuotesAware(";", "abc;d;xyz;1234");
		...
		// With Quotes
		//---------------------------------
		splitted = XRCSV.splitCSVQuotesAware(";", """
				"abc";"d";"xyz";"1234"
				""");
		...
		//---------------------------------
		splitted = XRCSV.splitCSVQuotesAware(";", " \"\"\"abc\"\"\";test;\"\"\"xyz\"\"\" ");
